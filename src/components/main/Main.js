  ...
  return (
    <div>
      <div className="top-section">
        ...
        <span>
          <b>
          это клуб единоборств в Екатеринбурге, который создан для людей, 
          желающих достигнуть высоких результатов в различных стилях боевых искусств. 
          <span className="top-section__extra-info-list"> В ходе своей активной деятельности 
          мы стремимся развивать и популяризировать следующие виды спортивной борьбы:
            <ul>
              <li>Бокс</li>
              <li>Грэпплинг</li>
              <li>Муай-тай</li>
